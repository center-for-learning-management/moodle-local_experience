...
$string['injectquestion:pleasewait'] = 'Die Vorlage wird geladen, bitte warten ...';
$string['injectquestion:pleasewait:subtext'] = 'Möglicherweise wird die Seite mehrmals neu geladen, um alle Einstellungen zu übernehmen.';
...
ai steht für ite Aussage, vi steht für iter Wahrheitswert, fbi steht für ites Feedback.
 WICHTIG:
- mindestens 4 Einträge von txt1 bis txt4 müssen ersetzt werden.
- Werden weniger als 8 Aussagen gesetzt, muss unten das Array aussagen enstprechend gekürzt werden. Beispielsweise bei nur 6 Aussagen steht dann: aussagen: [a1,a2,a3,a4,a5,a6];
- standardmäßig ist die erste Aussage wahr, die zweite falsch. Das kann natürlich geändert werden. Auch eine dritte Aussage kann hinzugefügt werden. vi muss dann entsprechend verändert werden. Auch kann die zweite Aussage gelöscht werden, z.B: txt1: [" Aussage 1A"]. Unter v1 müsste dann stehen: v1:true; oder v1: false;
...
<p>Wir haben für Sie zur Hilfestellung eine Vorlage für diesen Fragetyp vorbereitet.<br /><a href="#" onclick="require([\'local_experience/main\'], function(M) { M.injectQuestionTemplate(\'stack\', 0) }); return false;" class="btn btn-secondary"><i class="fa fa-plus-circle"></i> Vorlage für eine dynamische Multiple Choice Aufgabe im Stackformat einfügen</a></p>
';
