...
IMPORTANT:
- a minimum of 4 entries from txt1 to txt4 must be replaced.
- If less than 8 statements are set, the array below called "aussagen" must be shortened. For example, if only 6 statements are used: "aussagen: [a1,a2,a3,a4,a5,a6];"
- By default only the first statement is true, the second is wrong. This can be changed. Also, a third statement can be added. In that case, vi must be modified accordingly. Further, the second statement can be removed, e.g.: txt1 [" Aussage 1A"]. Below v1 is must say: v1:true; or v1:false;
